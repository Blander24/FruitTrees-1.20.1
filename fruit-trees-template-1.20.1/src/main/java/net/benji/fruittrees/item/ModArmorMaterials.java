...
public enum ModArmorMaterials implements ArmorMaterial {
    MANGO("mango", 25, new int[] {3, 8, 6, 3}, 19,
            SoundEvents.BLOCK_HONEY_BLOCK_PLACE, 2f, 0.1f, () -> Ingredient.ofItems(ModItems.MANGO_INGOT));
    ...
    public String getName() {
        return FruitTrees.MOD_ID + ":" + this.name;
    }
